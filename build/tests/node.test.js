  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            ...
            (0, supertest_1.default)(app_1.default)
              ...
              .field(
                "address",
                "test_0x4919B45b005058Fabc63AC2da39f7859eDeD9271"
              )
              .field(
                "json_data",
                JSON.stringify({
        ...
        case 1:
          response = _a.sent();
          expect(response.body.key).toBe(
            utils_services_1.utils.encrypt("my_lost_key")
          );
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          expect(response.body.key).toBe(
            utils_services_1.utils.encrypt("my_key_123")
          );
          return [2 /*return*/];
      }
    });
      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          expect(response.body.error).toBe(
            "key length too short, min: 6 chars"
          );
          return [2 /*return*/];
      }
    });
