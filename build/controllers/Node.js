...
var Node = /** @class */ (function () {
  ...
  Node.prototype.upload = function (req, res) {
    ...
    if (req.file) {
      req.body.json_data = __assign(__assign({}, req.body), {
        image: {
    ...
    var encrypted = utils_services_1.utils.encrypt(
  ...
  Node.prototype.createProfile = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        encrypted = utils_services_1.utils.encrypt(
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            return [
              4 /*yield*/,
              tipshotContract.methods.User(req.params.address).call(),
            ];
          case 1:
            user = _c.sent();
