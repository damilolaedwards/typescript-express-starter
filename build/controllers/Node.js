...
var Node = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        tx = _c.sent();
                        if (!(tx.purchased && utils_services_1.utils.decrypt(tx.key) == req.body.key)) return [3 /*break*/, 5];
    ...
    Node.prototype.createProfile = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (!utils_services_1.utils.isJsonString(JSON.stringify(req.body.data))) {
                    return [2 /*return*/, res.status(400).send({
                            error: "Invalid json data"
                        })];
                }
                encrypted = utils_services_1.utils.encrypt(JSON.stringify(req.body.data));
                payload = {
                    content: encrypted,
                };
                pinata
    ...
    Node.prototype.profile = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var user, content, decrypted, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, tipshotContract.methods.User(req.params.address).call()];
                    case 1:
                        user = _c.sent();
                        if (!user.profile) return [3 /*break*/, 4];
                        return [4 /*yield*/, fetch(gateway_url + user.profile)];
                    case 2:
                        content = _c.sent();
                        _b = (_a = utils_services_1.utils).decrypt;
                        return [4 /*yield*/, content.text()];
